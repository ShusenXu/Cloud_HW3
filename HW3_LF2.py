...
def lambda_handler(event, context):
    ...
    # query for testing
    query = 'show me photos with Dog and White Dog'
    ...
    host = 'https://search-photos-nhqs2kwjlmvqiaefek4e5mecnu.us-east-1.es.amazonaws.com'
    region = 'us-east-1'
    service = 'es'
    ...
    res = json.loads(requests.get(url, auth=aws_auth, headers=headers, data=json.dumps(query2)).text)
