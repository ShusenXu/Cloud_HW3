...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://glj80s8oof.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.uploadFolderItemPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'item', 'folder'], ['body']);
